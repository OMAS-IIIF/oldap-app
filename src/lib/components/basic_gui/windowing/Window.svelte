...
>
	...
	{#if resizable}
		...
		<div class="absolute w-3.5 h-3.5 bg-transparent -left-0.5 -top-0.5 cursor-[nwse-resize]" on:pointerdown={(e) => onResizePointerDown('nw', e)} />
		<div class="absolute w-3.5 h-3.5 bg-transparent -right-0.5 -top-0.5 cursor-[nesw-resize]" on:pointerdown={(e) => onResizePointerDown('ne', e)} />
		<div class="absolute w-3.5 h-3.5 bg-transparent -left-0.5 -bottom-0.5 cursor-[nesw-resize]" on:pointerdown={(e) => onResizePointerDown('sw', e)} />
		<div class="absolute w-3.5 h-3.5 bg-transparent -right-0.5 -bottom-0.5 cursor-[nwse-resize]" on:pointerdown={(e) => onResizePointerDown('se', e)} />
	{/if}
</div>