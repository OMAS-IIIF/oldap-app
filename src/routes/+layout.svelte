...
<div class="navbar bg-gradient-to-b from-[rgb(0,0,0)] to-[rgb(112,112,130)] text-white h-10">
	<div class="flex items-center space-x-3 rtl:space-x-reverse">
		<a href="/" class="flex items-center space-x-3 rtl:space-x-reverse">
			<img src="OldapLogo.001.png" class="h-12" alt="Flowbite Logo" />
		</a>
		...
		<!--<a href="/" class="btn btn-ghost btn-sm text-xs"><img src="OldapLogo.001.png" alt="logo" class="h-8 object-scale-down" /></a> -->
		<!--<div class="flex-none">
			<a href="/admin" class="btn btn-ghost btn-sm text-xs">Admin</a>
		</div>
		<div class="flex-none grow"></div>
		<div class="flex-none"><Loginout /></div> -->
	</div>
</div>
