...
<div class="absolute top-0 left-0 right-0 bottom-0 overflow-auto">
	...
	<form class="max-w-128">
		<Textfield type='text' label={m.user_id()} name="userid" id="userid" placeholder="user id" required={true} value={user?.userId.toString()} pattern={ncname_pattern}/>
		<Textfield type='text' label={m.family_name()} name="familyName" id="familyName" placeholder="family name" required={true} value={user?.familyName} />
		<Textfield type='text' label={m.given_name()} name="givenName" id="givenName" placeholder="given name" required={true} value={user?.givenName} />
		<Textfield type='email' label={m.email()} name="email" id="email" placeholder="john.doe@example.org" required={true} value={user?.email} pattern={email_pattern} />
		...
		<Table title={m.projects()} description={m.perprojperms()} action_elements={actions}>
			...
			<TableBody>
				<TableRow>
					...
					<TableItem><input type="checkbox"></TableItem>
					<TableItem><Button round={true}>XXX</Button></TableItem>
				</TableRow>
				<TableRow>
